...
const Footer: React.FC = () => {
	return (
		<footer className="bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-300 pt-12 pb-6 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div>
						...
						<ul className="space-y-3 text-gray-500 dark:text-gray-400 text-sm">
							<li className="flex items-start gap-3">
								<MapPin className="w-5 h-5 text-brand-600 dark:text-brand-500 flex-shrink-0" />
								<span>
							...
							<li className="flex items-center gap-3">
								<Phone className="w-5 h-5 text-brand-600 dark:text-brand-500" />
								<span>055-244-666</span>
							</li>
							<li className="flex items-center gap-3">
								<Mail className="w-5 h-5 text-brand-600 dark:text-brand-500" />
				...
				<div className="border-t border-gray-200 dark:border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
					...
					<div className="flex space-x-4">
						<a
							href="#"
							className="text-gray-400 hover:text-brand-600 dark:hover:text-white transition-colors"
						>
